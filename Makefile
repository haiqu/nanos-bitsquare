...
APP_LOAD_PARAMS=--appFlags 0x00 --icon "010000000000ffffffffffffffffff1ff11ff18ff177ef111111119199efff1ff11ff19ff9ffffffff"
...
# Compiler #
##############
GCCPATH   := $(BOLOS_ENV)/arm-none-eabi/bin/
